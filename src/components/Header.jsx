  ...
  return (
    <header className="bg-MidnightGreen relative">
      <nav className="customContainer mx-auto px-5 items-center flex justify-between pt-16 fontBody-1">
        ...
        {menuMobile && (
          <div className="block laptop:hidden absolute bg-PoliceBlue top-0 right-0 max-w-[255px] w-full min-h-screen z-10 pt-14">
            <button onClick={() => setMenuMobile(!menuMobile)} className="text-white text-[2rem] absolute right-6  hover:text-LightCoral">X</button>
